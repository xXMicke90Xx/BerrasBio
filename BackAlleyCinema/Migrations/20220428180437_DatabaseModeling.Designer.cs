...
namespace BackAlleyCinema.Migrations
{
    ...
    [Migration("20220428180437_DatabaseModeling")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackAlleyCinema.Models.Schedule", b =>
                {
                    ...
                    b.Property<DateTime>("Views")
                        .HasColumnType("datetime2");

                    b.HasKey("MovieId", "SaloonId");
            ...
            modelBuilder.Entity("BackAlleyCinema.Models.Schedule", b =>
                {
                    ...
                    b.HasOne("BackAlleyCinema.Models.Saloon", "Saloon")
                        .WithMany()
            ...
            modelBuilder.Entity("MovieSaloon", b =>
                {
                    b.HasOne("BackAlleyCinema.Models.Movie", null)
                        .WithMany()
                        .HasForeignKey("MoviesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BackAlleyCinema.Models.Saloon", null)
                        .WithMany()
